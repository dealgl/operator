...
(function() {
                ...
                buttons : [
                           {
                               ...
                               handler : function(self) {
                        	   		Ext.getCmp(_winFiles).getForm().submit({                    	
                                        url: 'tradeclaims/save-trade-claims-doc.html',
    ...
    container = new Ext.FormPanel({
        id :'view-trade-point-claims-component',
        frame :true,
        closable : true,
        header : false,
        autoScroll : true,
        ...
        loadData : function(data) {
        	this.setTitle("Претензии торговых точек<br/><b>" + "Документы" + "</b>");        	
        	this.data = data;
            if (data['file'][0]){
            	store.loadData(data);
            }
