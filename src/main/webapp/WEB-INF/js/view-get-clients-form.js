(function () {
            ...
            "-",
            {
                ...
                handler : function(self) {
                    Ext.Msg.show({
                        ...
                        msg: 'Вы уверены, что хотите отправить пароль клиенту?',
                        ...
                        fn : function(btn){
                            ...
                            if (btn=='ok')
                                Ext.Ajax.request({
                                    url: 'clients/send-password.html',
                                    params: {
                                        snils: ids
                                    },
                                    success: function (response) {
                    ...
                    if (ids==''){
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function (response) {
                                var data = Ext.decode(response.responseText);
                                if (data.success) {
                                    Ext.MessageBox.alert('Информация','Клиент заблокирован!');
                                }
                                else {
                                    console.log('Error: ' + response.responseText);
                                }
    ...
    container = new Ext.FormPanel({
        ...
        loadData : function(data) {
            this.setTitle("Работа с клиентами");
            this.data = data;
