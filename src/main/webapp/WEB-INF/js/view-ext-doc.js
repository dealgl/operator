...
(function () {
              	  ...
              	  winFiles.show();
                                    	...
                                    	handler : function(self) {
                                    		...
                                    		if (ids == '') {
                								Ext.MessageBox
                									...
                									window.open(String.format('externaldocuments/view-ext-doc.html?id={0}&type={1}',ids,idn));
                								} 
                                       }
                                    },
                                    
                                    {
                                		...
                                		if (ids == '') {
    										...
    										Ext.Ajax.request( {
    											url : 'externaldocuments/delete-ext-doc.html',
    											params : {
    												id: ids
    											},
    											timeout : 1000000000,
    ...
    container = new Ext.FormPanel({
        ...
        loadData : function(data) {
        	this.setTitle("Внешние проекты <br/><b>" + "Документы" + "</b>");        	
        	this.data = data;
            if (data['file'][0]){
            	store.loadData(data);
            }
