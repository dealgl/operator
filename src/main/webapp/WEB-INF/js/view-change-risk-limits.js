...
(function() {
                ...
                buttons : [
                           {
                               ...
                               handler : function(self) {
                        	   		Ext.getCmp(_winFiles).getForm().submit({                    	
                                        url: 'changerisklimits/save-change-risk-limits-doc.html',
    ...
    container = new Ext.FormPanel({
        id :'view-change-risk-limits-component',
        frame :true,
        closable : true,
        header : false,
        autoScroll : true,
        ...
        loadData : function(data) {
        	this.setTitle("Изменение ограничений рисковых правил<br/><b>" + "Документы" + "</b>");        	
        	this.data = data;
            if (data['file'][0]){
            	store.loadData(data);
            }
