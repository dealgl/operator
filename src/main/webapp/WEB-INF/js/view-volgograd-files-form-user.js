...
(function () {
        ...
        tbar : [
                                    {
                						...
                						if (ids == '') {
                							...
                							window.open(String.format('volgograd/view-volgograd-file.html?id={0}&type={1}',ids, idn));
                						}
                                       }
                                    }
                ],
    ...
    container = new Ext.FormPanel({
        id :'view-volgograd-files-form-user-component',
        frame :true,
        closable : true,
        header : false,
        autoScroll : true,
        ...
        loadData : function(data) {
        	this.setTitle("Экспресс-Волга (Волгоградский филиал)<br/><b>" + "Документы" + "</b>");        	
        	this.data = data;
            if (data['file'][0]){
            	store.loadData(data);
            }
