...
@Component
@Result(type = "json")
public class SetAutoCallAction {

	final static Log log = LogFactory.getLog(SetAutoCallAction.class);
	...
	@Action("set-auto-call")
	public String setAutoCallStatus(){
		String res="";	 
		res=OracleDBManager.getInstance().setAutoCallStatus(face_id,autoCall); 
	return "success";
	   }
