...
@Component
@Result(type = "json")
public class DelAutoCallArrayAction {

	final static Log log = LogFactory.getLog(DelAutoCallArrayAction.class);
	...
	@Action("del-auto-call-array")
	public String delAutoCallArray() throws Exception {
	   	String output="";
	   	...
	   	for (int i = 0; i < array.length; i++) {
	   		output = OracleDBManager.getInstance().setAutoCallStatus(array[i],"0");
	   	}
