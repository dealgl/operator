...
@Component
@Result(type = "json")
public class SetAutoCallArrayAction {

	final static Log log = LogFactory.getLog(SetAutoCallArrayAction.class);
	...
	public void setCity(String city) {
	   ...
	   @Action("set-auto-call-array")
	   public String setAutoCallArray() throws Exception {
	   	String output="";
	   	...
	   	for (int i = 0; i < array.length; i++) {
	   		output = OracleDBManager.getInstance().setAutoCallStatus(array[i],"1");
	   	}
