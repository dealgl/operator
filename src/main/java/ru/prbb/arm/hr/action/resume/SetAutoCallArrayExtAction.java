...
@Component
@Result(type = "json")
public class SetAutoCallArrayExtAction {

	final static Log log = LogFactory.getLog(SetAutoCallArrayExtAction.class);
	...
	public void setCity(String city) {
	   ...
	   @Action("set-auto-call-array-ext")
	   public String execute() throws Exception {
	   	...
	   	for (int i = 0; i < array.length; i++) {
	   		output = OracleDBManager.getInstance().setAutoCallStatusExt(array[i],"1");
	   	}
