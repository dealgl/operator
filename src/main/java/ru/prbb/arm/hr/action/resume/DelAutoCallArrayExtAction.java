...
@Component
@Result(type = "json")
public class DelAutoCallArrayExtAction {

	final static Log log = LogFactory.getLog(DelAutoCallArrayExtAction.class);
	...
	@Action("del-auto-call-array-ext")
	public String execute() throws Exception {
	   	...
	   	for (int i = 0; i < array.length; i++) {
	   		output = OracleDBManager.getInstance().setAutoCallStatusOnExt(array[i],"0");
	   	}
